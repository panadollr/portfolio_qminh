...
class BlogCrudController extends CrudController
{
    ...
    {
        CRUD::addColumn(['name' => 'title', 'label' => 'Tiêu đề']);
        CRUD::addColumn(['name' => 'image', 'label' => 'Ảnh']);
        CRUD::addColumn(['name' => 'content', 'label' => 'Nội dung']);
        CRUD::addColumn(['name' => 'author', 'label' => 'Tác giả']);
        CRUD::addColumn(['name' => 'category', 'label' => 'Danh mục']);
        CRUD::addColumn(['name' => 'created_at', 'label' => 'Ngày viết']);
